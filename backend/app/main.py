...
app.include_router(production_batches.deep_logger_router, tags=["batches_frontend"])
app.include_router(production_batches.light_logger_router, tags=["batches_frontend"])
...
app.include_router(multipacks.light_logger_router, tags=["multipacks_frontend"])
