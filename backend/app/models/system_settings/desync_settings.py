...
class DesyncConstantSettings(EmbeddedModel):
    ...
    max_packs_on_assembly_multiplier: MaxPacksOnAssemblyMultiplier = (
        MaxPacksOnAssemblyMultiplier()
    )
    max_multipacks_exited_pintset_multiplier: MaxMultipacksExitedPintsetMultiplier = (
        MaxMultipacksExitedPintsetMultiplier()
    )
    max_wrapping_multipacks: MaxWrappingMultipacks = MaxWrappingMultipacks()
    max_multipacks_entered_pitchfork_multiplier: MaxMultipacksEnteredPitchforkMultiplier = (
        MaxMultipacksEnteredPitchforkMultiplier()
    )
    max_multipacks_on_packing_table_multiplier: MaxMultipacksOnPackingTableMultiplier = (
        MaxMultipacksOnPackingTableMultiplier()
    )
