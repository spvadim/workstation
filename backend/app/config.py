...
from .models.system_settings.email_settings import MailSettings
from .models.system_settings.erd_settings import (
    ERDBuzzerOID,
    ERDCommunityString,
    ERDFifthOID,
    ERDFirstOID,
...
from .models.system_settings.general_settings import (
    CurtainOpeningDelay,
    DaysToDelete,
    GeneralSettings,
    PintsetStop,
...
from .models.system_settings.location_settings import (
    LocationSettings,
    PlaceName,
    TimeZone,
)
from .models.system_settings.pintset_settings import (
    PintsetBitNumber,
    PintsetByteNumber,
    PintsetDbName,
    PintsetIp,
    PintsetRack,
    PintsetReadingLength,
    PintsetSettings,
    PintsetSlot,
    PintsetStartingByte,
    PintsetTurningOffValue,
    PintsetTurningOnValue,
)
from .models.system_settings.system_settings import SystemSettings
from .models.system_settings.telegram_settings import TGChat, TGSettings, TGToken
...
default_location_settings = LocationSettings(
    place_name=default_place_name, time_zone=default_time_zone
)
# set default general settings
default_days_to_delete = DaysToDelete(value=os.getenv("DROP_DATA_INTERVAL_DAYS"))
...
default_applikator_curtain_opening_delay_bad_label = CurtainOpeningDelay(
    title="Задержка открытия шторки после аппликатора при плохой этикетке пачки",
    desc="Введите задержку открытия шторки после аппликатора в секундах",
)
default_applikator_curtain_opening_delay_bad_packing = CurtainOpeningDelay(
    title="Задержка открытия шторки после аппликатора при плохой упаковки пачки",
    desc="Введите задержку открытия шторки после аппликатора в секундах",
)
...
default_general_settings = GeneralSettings(
    ...
    applikator_curtain_opening_delay_bad_height=default_applikator_curtain_opening_delay_bad_height,
    applikator_curtain_opening_delay_bad_label=default_applikator_curtain_opening_delay_bad_label,
    applikator_curtain_opening_delay_bad_packing=default_applikator_curtain_opening_delay_bad_packing,
...
default_pintset_byte_number = PintsetByteNumber(value=os.getenv("PINTSET_BYTE_NUMBER"))
default_pintset_bit_number = PintsetBitNumber(value=os.getenv("PINTSET_BIT_NUMBER"))
...
default_tg_settings = TGSettings(tg_token=default_tg_token, tg_chat=default_tg_chat)
